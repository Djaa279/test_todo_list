package com.test.todolist.base
...
abstract class BasePresenter<T> : LifecycleObserver where T : LifecycleOwner {
    ...
    /*
    * Create open function that can be override
    * and will be called whenever lifeCycle event take place
    * */
    ...
    open fun onDestroy() {
        // To prevent memory leak we remove observer from target
        dropTarget()
    }
}